...
public class Main {
    ...
    public static void main(String[]args) {
       ...
       //System.out.println(userEspecial.getNivelBeneficio());
        ...
        GerenciaLivro.tornarDisponivel(livro1);
        GerenciaLivro.tornarDisponivel(livro2);
        System.out.println("Livros disponíveis: " + GerenciaLivro.livrosDisponiveis + "\n");
        System.out.println("Quantidade de livros disponíveis: " + GerenciaLivro.livrosDisponiveis.size() + "\n");
